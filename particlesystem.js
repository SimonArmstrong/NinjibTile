...
function createMistEmitter1(particleTexture, posX, posY)
{
	var emitter = new Emitter(particleTexture, posX, posY);
	return emitter;
}

function createMistEmitter2(particleTexture, posX, posY)
{
	var emitter = new Emitter(particleTexture, posX, posY);
	return emitter;
}

function createMistEmitter3(particleTexture, posX, posY)
{
	var emitter = new Emitter(particleTexture, posX, posY);
	return emitter;	
}
