...
items.push(new Item("Leather Pants", 20, 0, 4, "Pants", "placeHolderArmour.png"));
items.push(new Item("Chain Pants", 32, 0, 11, "Pants", "placeHolderArmour.png"));
items.push(new Item("Iron Leggings", 45, 0, 20, "Pants", "placeHolderArmour.png"));

items.push(new Item("Cloth Hat", 10, 0, 1, "Hat", "placeHolderArmour.png"));
items.push(new Item("Leather Hat", 18, 0, 3, "Hat", "placeHolderArmour.png"));
items.push(new Item("Chain Helmet", 30, 0, 10, "Hat", "placeHolderArmour.png"));
items.push(new Item("Iron Helmet", 43, 0, 15, "Hat", "placeHolderArmour.png"));
...
items.push(new Item("Chain Boots", 20, 0, 7, "Shoes", "placeHolderArmour.png"));
items.push(new Item("Iron Boots", 35, 0, 13, "Shoes", "placeHolderArmour.png"));
